    ...
    <MainLayout withNavigation={false}>
      <div className="min-h-[calc(100vh-2rem)] flex flex-col items-center justify-center p-4 text-center">
        <div className="space-y-6 opacity-100 animate-fade-in">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mt-6 opacity-100 animate-fade-in">
            당신의 잠, 퍼포먼스가 되다.
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground max-w-md mx-auto opacity-100 animate-fade-in">
